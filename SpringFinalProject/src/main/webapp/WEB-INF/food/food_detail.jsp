  ...
  <main class="container clear"> 
   ...
   <div class="two_third first">
     <table class="table">
      <tr>
       <td colspan="2">
        <h3><span id="name">{{food_detail.name}}</span>&nbsp;<span style="color:pink">{{food_detail.score}}</span></h3>
       </td>
      </tr>
      <tr>
       <th width=20%>주소</th>
	      ...
	      <table class="table">
	       <tr>
	        <td>
	         ...
	         <input type="button" value="댓글 쓰기" class="btn btn-sm btn-primary"
...
// 댓글
 new Vue({
	...
	data:{
		...
		reply_list:[],
		sessionId:'',
		type:10, // type이 10번이고 fno(맛집 번호)인 경우
		msg:''
	},
	mounted:function(){
		let _this=this;
 ...
 new Vue({
	 ...
	 methods:{
		 addScript:function(){
			 ...
			 //(키 값 추가)
			 script.src='http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=ae12aff8e45e62ef0437d634b152c8df&libraries=services'
