...
$(function(){
	 $('.ups').click(function(){
		 $('.updates').hide();
		 let no=$(this).attr("data-no"); //data-no="${rvo.no }"
		 if(i==0)
		 {
			 $('#u'+no).show("slow");
			 $(this).text("취소");
...
<body>
                ...
                <tr style="display:none" id="u${rvo.no }" class="updates">
	             <td>
	              <form method="post" action="../reply/update.do">
	                ...
	                <input type=submit value="댓글 수정" style="float: left;height: 104px" class="btn btn-sm btn-info">
	              </form>
	             </td>
	            </tr>
              </table>
    ...
    <div id="menu_wrap" class="bg_white">
        ...
        <div id="pagination"></div>
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ae12aff8e45e62ef0437d634b152c8df&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
