...
@RestController
@RequestMapping("food/")
@CrossOrigin("http://localhost:3000") //3000포트 허용
public class FoodRestController {
	...
	{
		List<FoodLocationEntity> list=lDao.foodlocationData();
	...
	public CategoryEntity category_info_react(int cno)
	{
	...
	public FoodEntity food_detail_react(int fno)
	{
